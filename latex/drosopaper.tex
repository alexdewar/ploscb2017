...
The predicted responses were calculated by convolving RF outputs with a calcium response function (a linear operation).
...
$$
where $\hat{g}(i,j)$ is a recentred kernel (Figure~\ref{fig:avkernels}C).
