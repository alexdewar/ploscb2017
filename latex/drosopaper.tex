...
For example, bees have a well-attested ability to learn many varied patterns, which presumably derives from a need to learn flowers [cit].
It is not apparent, however, that there has been a comparable selection pressure on \emph{Drosophlia} for such a general learning ability.
