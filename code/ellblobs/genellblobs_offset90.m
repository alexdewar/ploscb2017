...
%     az = linspace(fov(1,1),fov(1,2),nuvar);
    ...
    kernels = [vf_avkernels_r2,vf_avkernels_r4];
    lk = kernels(cell2mat({kernels.isleft}));
...
if ~debug
    ...
    fprintf('Saving to %s...\n',fname);
    save(fname,'x_im','x_kern','orients','areas','el','az','majoraxis','minoraxis', ...
         'im_size','scale','amp','phi','freq','maxfreq','maxamp','nvar','nwave','job','starti');
end