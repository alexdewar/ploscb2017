function ml_nntest_indivplots_ellblobs90_noel
    doplot = true;
    dosave = true;
    ptrain = 0.4;
    sz = [16 5];
...
%     load(['ml_inputs_azimuths' suffix '.mat'],'t','r2_ind','r4_ind');
    load(['./ellblobs/ellblob' suffix '.mat'],'majoraxis','orient','x_im','x_kern');
    r2_ind = 1:28;
    r4_ind = 29:42;
    t = [orient, majoraxis];
    t = bsxfun(@rdivide,bsxfun(@minus,t,min(t)),range(t));
